  ...
  return (
    <footer className="bg-light text-center text-lg-start border-top py-3 mt-auto">
      <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center">
        ...
        <div>
          <a href="https://github.com/ashishkarche/chotu-link" className="text-muted me-3">
            <i className="bi bi-github fs-5"></i>
          </a>

          <a href="https://www.linkedin.com/in/ashish-karche-1a422b317/" className="text-muted">
